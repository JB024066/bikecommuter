...
get the app created:
    ...
    $ heroku apps:create bikecommuter
    Creating bikecommuter... done, stack is cedar
    http://bikecommuter.herokuapp.com/ | git@heroku.com:bikecommuter.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://bikecommuter.herokuapp.com deployed to Heroku

    To git@heroku.com:bikecommuter.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://bikecommuter.herokuapp.com
    ["Hello" :from Heroku]
...
Then you can launch the REPL:
    ...
    $ lein repl :connect http://$REPL_USER:$REPL_PASSWORD@bikecommuter.herokuapp.com/repl
